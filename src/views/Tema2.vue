...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-md-5.mb-5
    ...
    p.mb-5 A partir de lo anterior se debe analizar lo referente a la anatomía, respecto a la existencia de varias formas de busto:
      
    .row.align-items-center.justify-content-center(data-aos="fade")
      .col-sm-12.col-md-12.col-lg-4
        .bloque-texto-c.color-acento-contenido.estilo300
          .row.align-items-center.justify-content-center
            .col-8
              img(src='@/assets/curso/temas/tema2/tarjeta2/imagen1.svg')
          .row.align-items-center.justify-content-center
            .col-4  
              p.text-center #[b Pera: ]
          .row.align-items-center.justify-content-center
    ...
    .row(style='background-color: #673AB7')(data-aos="fade")
      .col-sm-12.col-md-12.col-lg-12
        h4.text-center.mb-3(style='color: white') #[b Para cada forma de busto existen recomendaciones para la silueta de #[em brasier]: ]
    .row.align-items-center.justify-content-center(data-aos="fade")
      .col-sm-12.col-md-12.col-lg-4
        .bloque-texto-c.estilo400.color-acento-contenido
          .row.align-items-center.justify-content-center
            .col-6
      ...
      .col-sm-12.col-md-12.col-lg-4
        .bloque-texto-c.estilo400.color-acento-contenido
          .row.align-items-center.justify-content-center
            .col-6
              ul.lista-ul--color.vmoradaclarapeq.fa-ul.mb-5
                li.mb-0 
                  i.fas.fa-cookie
                  span.mb-0 #[b Copa redonda ]
      .col-sm-12.col-md-12.col-lg-4
    ...
    .row.mb-4(style="border-bottom : solid 1px #E4E4E4")(data-aos="fade")
    ...
    .row.align-items-center.justify-content-center(style='background-color: #E2E6FF')
      .titulo-sexto.color-acento-contenido
        h5 Figura 30.
    ...
    h3.text-center Medidas anatómicas
    ...
    h3.text-center Áreas a medir prenda terminada
    ...
    AcordionA(tipo="b" clase-tarjeta="tarjeta bgamarillo")
    ...
    .row.justify-content-center.align-items-center.bgmoradoclaro.mb-5(data-aos="fade")
      p.text-center #[b  Otras siluetas de  #[em lingerie  ]   ]
      .col-lg-12
        SlyderF.bgmoradoclaro.mb-3(columnas="col-lg-6 col-xl-4")
  ...
  .container.tarjeta.tarjeta--blanca.p-md-5
  ...
  .container.tarjeta.tarjeta--blanca.p-md-5
    ...
    p En el siguiente vídeo encontrará el paso a paso con la explicación para el trazo manual del panti básico. 
    ...
    p En el siguiente vídeo encontrará el paso a paso con la explicación para el trazo manual del panti #[em culotte]. 
    ...
    p En el siguiente video encontrará el paso a paso con la explicación para el trazo manual del panti #[em hipster] con encaje.  
    ...
    p En el siguiente vídeo encontrará el paso a paso con la explicación para el trazo manual del panti bóxer con encaje. 
    ...
    p En el siguiente video encontrará el paso a paso con la explicación para el trazo manual del panti faja - cintura alta.  
    ...
    p En el siguiente video encontrará el paso a paso con la explicación para el trazo manual del panti tanga descaderada. 
    ...
    .row.justify-content-center.align-items-center
      .col-sm-12.col-md-10.col-lg-6(data-aos="fade")
        .titulo-sexto.color-acento-contenido
          h5 Figura 38. 
          span 
    ...
    p En el siguiente video encontrará el paso a paso con la explicación para el trazo manual del panti tanga de encaje. 
    ...
    p En el siguiente vídeo encontrará el paso a paso con la explicación para el trazo manual del #[em brasier balconet] con cotilla.  
    ...
    .row.align-items-center.justify-content-center.mb-4
      .col-sm-12.col-md-9.col-lg-9
        .tarjeta.actividad.color-acento-contenido
