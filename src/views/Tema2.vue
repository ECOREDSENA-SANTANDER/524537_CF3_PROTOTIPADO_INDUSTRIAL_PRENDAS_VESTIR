...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-md-5.mb-5
    ...
    .subt.mb-4(data-aos="fade-right")
      .d-flex.align-items-center.mb-1
        img(src='@/assets/curso/temas/subt.svg', alt='')
        h3.mb-0.ms-2 Generalidades para identificar la talla del #[em brasier]

    h4 ¿Cómo conocer la talla correcta?
    p Es una concepción un poco ilógica pensar en el hecho de que al ser mujeres no se cuente con la posibilidad de sentirse cómodas; que los senos deben adaptarse a cualquier producto encontrado en el mercado, caso contrario es aceptar que “el #[em brasier] debe adaptarse al busto”.
    ...
    .row.justify-content-center.mb-4
      .col-lg-4.col-md-6.mb-3
        .bg2.tarjeta.p-4.h-100
          ...
          .tarjeta.bg-white.w-fit.p-2.px-4.m-auto.mb-3
            h5.mb-0 Pera:
          p.mb-5 Aquel busto que tiene peso en su parte inferior y necesita ser levantado y sujetado.
      ...
      .col-lg-4.col-md-6.mb-3
        .bg2.tarjeta.p-4.h-100
          ...
          .tarjeta.bg-white.w-fit.p-2.px-4.m-auto.mb-3
            h5.mb-0 Cónico:
          p.mb-5 Generalmente, este busto también es un poco desviado hacia los costados y levantado en su parte superior, requiere prendas que lo junten y realcen.
          p.fw-bold Para cada forma de busto existen recomendaciones para la silueta de brasier:
          ul.lista-ul--color.fa-ul
            li.mb-0 
              i.fas.fa-cookie
      ...
      .col-lg-4.col-md-6.mb-3
        .bg2.tarjeta.p-4.h-100
          ...
          .tarjeta.bg-white.w-fit.p-2.px-4.m-auto.mb-3
            h5.mb-0 Redondo:
          p.mb-5 Aquellas a quienes envidiablemente les queda bien todos los brasieres que se colocan, su realce es natural con cualquier horma y lucen siempre un lindo escote.
          p.fw-bold Para cada forma de busto existen recomendaciones para la silueta de brasier:
          ul.lista-ul--color.fa-ul
            li.mb-0 
              i.fas.fa-cookie
              span.mb-0 #[b Toda silueta ]
    ...
    .subt.mb-4(data-aos="fade-right")
      .d-flex.align-items-center.mb-1
        img(src='@/assets/curso/temas/subt.svg', alt='')
        h3.mb-0.ms-2 Cómo colocarse el #[em brasier]

    .tarjeta.bg3.p-4.mb-5
      .titulo-sexto.color-acento-contenido
        h5 Figura 30.
        span.mb-0 Cómo colocarse el #[em brasier]
      figure
        img(src='@/assets/curso/temas/tema2/fig30.png', alt='La imagen describe el paso a paso de la manera como se debe poner un brasier')
    ...
    p El referente de medidas a trabajar como base es la talla 34 en copa B, en vista de que es la talla estándar para la línea de ropa interior femenina, en el ejemplo de un #[em brasier] con cotilla de silueta corte horizontal se presentan las medidas conforme aparecen en la imagen.
    ...
    h4.text-center.mb-4 Siluetas de #[em brasier]
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="fade")
      .col-sm-12.col-md-10.col-lg-8
        .titulo-sexto.color-acento-contenido
          h5 Figura 34. 
          span 
            span.mb-0 Panti #[em hipster] con encaje
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="fade")
      .col-sm-12.col-md-10.col-lg-7
          .titulo-sexto.color-acento-contenido
            h5 Figura 35. 
            span 
              span.mb-0 Panti #[em boxer] con encaje
          figure
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="fade")
      .col-sm-12.col-md-10.col-lg-6
        .titulo-sexto.color-acento-contenido
          h5 Figura 36. 
          span 
            span.mb-0 Panti faja- cintura alta
        figure
    ...
    p.mb-4 Para hacer el desarrollo del #[em brasier] se trabajan diferentes tipos de metodologías, en este caso se entrega el análisis y la interpretación general de un #[em brasier] con cotilla, sacando pieza por pieza cada uno de los elementos. 
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="fade")
      .col-sm-12.col-md-10.col-lg-6
        .titulo-sexto.color-acento-contenido
          h5 Figura 39. 
          span 
            span.mb-0 #[em Brasier balconet] con cotilla
        figure
          img(src='@/assets/curso/temas/tema2/imagen17.png', alt="Fotografía de una mujer luciendo un brasier balconet con cotilla.")
    
    p.mb-4 En el siguiente vídeo encontrará el paso a paso con la explicación para el trazo manual del #[em brasier balconet] con cotilla.      
    ...
    .row.align-items-center.justify-content-center.mb-4(data-aos="fade")
      ...
      .col-sm-12.col-md-9.col-lg-9
        p Para hacer el desarrollo del #[em brasier] se trabajan diferentes tipos de metodologías, en este caso se entrega el análisis y la interpretación general de un #[em bralette], sacando pieza por pieza cada uno de los elementos.
      ...
      .row.justify-content-around.align-items-center
        ...
        .col
          .row.justify-content-between.align-items-center
            .col.mb-3.mb-sm-0
              h4.mb-1 Anexo.
              p.mb-0 Instructivo de Interfaz audaces 
            .col-sm-auto
              a.boton.color-acento-botones(:href="('https://www.scribd.com/document/367907998/Manual-Audaces')" target="_blank")
                span Descargar
      ...
      .row.justify-content-around.align-items-center
        ...
        .col
          .row.justify-content-between.align-items-center
            .col.mb-3.mb-sm-0
              h4.mb-1 Anexo.
              p.mb-0 Bóxer de hombre, cómo hacerlo fácil y rápido:  
            .col-sm-auto
    ...
    p En el siguiente vídeo encontrará el trazo del pantaloncillo masculino con la entrega del paso a paso y metodología del trazo, y se hará la exploración desde el manejo del #[em software]; sin embrago, se podrá trabajar esta misma explicación de manera manual.
    ...
    p En el siguiente video encontrará el trazo de #[em brasier] altura de copa con la entrega del paso a paso y metodología del trazo, y se hará la exploración desde el manejo del #[em software]; sin embrago, se podrá trabajar esta misma explicación de manera manual.
    ...
    p En el siguiente video encontrará el trazo de la base copa corte vertical y horizontal con la entrega del paso a paso y metodología del trazo, y se hará la exploración desde el manejo del #[em software]; sin embrago, se podrá trabajar esta misma explicación de manera manual.
