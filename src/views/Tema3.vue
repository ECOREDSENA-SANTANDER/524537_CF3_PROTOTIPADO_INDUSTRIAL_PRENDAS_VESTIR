...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-md-5.mb-5
    ...
    .row.align-items-center.justify-content-center.mb-4(data-aos="fade")
      .col-sm-12.col-md-12.col-lg-5
        ...
        .bloque-texto.pt-4.px-5.mb-5 
          h3.text-regular.bloque-texto-f__texto.text-center #[b Preparación de las piezas ]
      ...
      .col-sm-12.col-md-12.col-lg-5
        ...
        .bloque-texto.pt-4.px-5.mb-5 
          h3.mb-0.text-regular.bloque-texto-f__texto.text-center #[b Ensamble de camisa ]
    ...
    .tarjeta.tarjeta--azul.color-acento-contenido
      SlyderA(tipo="b")
        .row.justify-content-center.align-items-center.my-lg-4
          .row.justify-content-center.align-items-center 
    ...
    .row.mb-4
      ...
      h4.mb-4.text-center Orden operacional de confección de blusa femenina
    ...
    .row.align-items-center.justify-content-center
      .col-sm-12.col-md-12.col-lg-5
        ...
        .bloque-texto.pt-4.px-5.mb-5 
          h3.mb-4.text-regular.bloque-texto-f__texto.text-center #[b Preparación de las piezas ]
      ...
      .col-sm-12.col-md-12.col-lg-5
        ...
        .bloque-texto.pt-4.px-5.mb-5.align-items-center.justify-content-center 
          h3.mb-5.text-regular.bloque-texto-f__texto.text-center #[b Ensamble de blusa ]
          .row.align-items-center.justify-content-center.mb-5
            .col-7
              img(src='@/assets/curso/temas/tema3/imagen6.svg')
    
    .row.align-items-center.justify-content-center
      h3.mb-2 A. Preparación de las piezas
    ...
    .row.align-items-center.justify-content-center
      .col-sm-12.col-md-9.col-lg-9
        h3.mb-5 B. Ensamble de blusa femenina
      ...
      .col-sm-12.col-md-12.col-lg-5
        .bloque-texto-f__avatar
          .bloque-texto-f__avatar__img
            img(src='@/assets/curso/temas/tema3/Aavatar-amarillo.svg')
        .bloque-texto.pt-4.px-5.mb-5 
          h3.mb-5.text-regular.bloque-texto-f__texto.text-center #[b Preparación de las piezas ]
      ...
      .col-sm-12.col-md-12.col-lg-5
        .bloque-texto-f__avatar
          .bloque-texto-f__avatar__img
            img(src='@/assets/curso/temas/tema3/Bavatar-amarillo.svg')
        .bloque-texto.pt-4.px-5.mb-5.align-items-center.justify-content-center 
          h3.mb-3.text-regular.bloque-texto-f__texto.text-center #[b Ensamble de falda  ]
          .row.align-items-center.justify-content-center
            .col-7
              img(src='@/assets/curso/temas/tema3/imagen10.svg')
    
    .row.align-items-center.justify-content-center
      h3.mb-3 A. Preparación de las piezas
    ...
    .row.align-items-center.justify-content-center.mb-4
      .col-6.col-md-3.col-lg-3
        img(src='@/assets/curso/temas/tema3/imagen12.png')
      .col-sm-12.col-md-9.col-lg-9
    ...
    .row.mb-4(style="border-bottom : solid 1px #E4E4E4")
      ...
      .col-sm-12.col-md-12.col-lg-5
        .bloque-texto-f__avatar
          .bloque-texto-f__avatar__img
            img(src='@/assets/curso/temas/tema3/Aavatar.svg')
        .bloque-texto.pt-4.px-5.mb-5 
          h3.text-center #[b Preparación de las piezas ]
      ...
      .col-sm-12.col-md-12.col-lg-5
        .bloque-texto-f__avatar
          .bloque-texto-f__avatar__img
            img(src='@/assets/curso/temas/tema3/Bavatar-morado.svg')
        .bloque-texto.pt-4.px-5.mb-5.align-items-center.justify-content-center 
          h3.text-center.mb-4 #[b Ensamble de pantalón ]
          .row.align-items-center.justify-content-center
            .col-7
      ...
      .col-sm-12.col-md-12.col-lg-12
        .row
          .col-sm-12.col-md-11.col-lg-11.cajon.color-primario
            .row
              .col-sm-12.col-md-10.col-lg-10
                p Para el montaje de una cremallera con sistema de aletilla y aletillón es necesario identificar cada una de las piezas y tener en cuenta que los acabados y los pasos para el ensamble y el desarrollo pueden variar.
      ...
      .col-sm-12.col-md-12.col-lg-12
        .row
          .col-sm-12.col-md-11.col-lg-11.cajon.color-primario
            .row
              .col-sm-12.col-md-10.col-lg-10
                p Existen diferentes tipos de bolsillos de ribete, de igual manera varias  formas de confeccionarlos, se debe tener en cuenta que su orden varía dependiendo el tipo de complemento del bolsillo.
        .col-11.position-relative
          .avatar
    ...
    .row.align-items-center.justify-content-center
      .col-sm-12.col-md-12.col-lg-10
        h3.mb-4 A. Preparación de las piezas
    ...
    .row.align-items-center.justify-content-center
      .col-sm-12.col-md-12.col-lg-10
        h3.mb-4 B. Ensamble de pantalón
