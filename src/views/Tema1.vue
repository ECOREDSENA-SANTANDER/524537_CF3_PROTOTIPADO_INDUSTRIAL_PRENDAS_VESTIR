...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .col-lg-7
          ...
          .row
            .col-lg-7
              ...
              hr.my-2
            .col-lg-5
              p.mb-0 3. Complementos
              hr.my-2 
              p.mb-0 4. Señalización
              hr.my-2 
              p.mb-0 5. Despiece
              hr.my-2
    ...
    .row.mb-5
      .col-lg-7
        ul.lista-ul--color.color-acento-contenido.mb-4
          li
            i.fas.fa-atom
            span.mb-0 #[b Base superior]
          li
            i.fas.fa-atom
            span.mb-0 #[b Base inferior de falda]
          li
            i.fas.fa-atom
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-4
        ...
        figcaption.text-small Fuente: Manual_patronaje_basico_interpretacion_disenos.PDF - SENA
        ...
        AcordionA(tipo="a" clase-tarjeta="tarjeta bg1")
          .row.justify-content-center(titulo="Cuadro de Tallas Femeninas con medidas anatómicas sin desahogos, se presentan en centímetros.")
            .col-md-10
              ...
              figcaption Fuente: Manual_patronaje_basico_interpretacion_disenos.PDF - Sena
    ...
    .row.justify-content-evenly.mb-4(data-aos="fade-left")
      .col-md-6.col-lg-6.mb-3.mb-md-0
        .titulo-sexto.color-acento-contenido
          h5 Figura 13.
    ...
    .subt.mb-4(data-aos="fade-right")
      .d-flex.align-items-center.mb-1
        img(src='@/assets/curso/temas/icon-title.svg', alt='')
        h3.mb-0.ms-2 Modificaciones de manga
    ...
    .bloque-texto-g.bg2.p-3.p-sm-4.p-md-5.mb-4(data-aos="fade")
      ...
      .bloque-texto-g__texto.p-4.py-lg-5
        p.mb-0 Cuando se habla de cuellos, lo primero que se debe tener en cuenta es la base y forma de cada escote, esto es, si se habla de la parte funcional del cuello; el cuello es una extensión o pieza adicional que se une a un escote, tanto delantero como posterior.
        
    p.mb-5 Al trabajar bajo el contexto funcional y no comercial, todos los cuellos en patronaje se dividen en tres grandes grupos:
    ...
    .row.justify-content-center.mb-5(data-aos="fade")
      .col-sm-12.col-lg-12
        .bloque-texto-g.bloque-texto-g--inverso.bg2.p-3.p-sm-4.p-md-5
          .bloque-texto-g__img(
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-8.bg2.p-4.p-lg-5
        ul.lista-ul--color.fa-ul.p-lg-5
          li 
            i.fas.fa-atom 
    ...
    p.mb-4 Para el desarrollo del trazo de prendas superiores se trabajarán tres imágenes de referencia, en las cuales podrá identificar dos prendas para niña y una prenda para niño, la finalidad del ejercicio es poder comparar de qué manera se puede implementar el básico, llevándolo hacia cualquier tipo de prenda.
    ...
    p.mb-4 En el siguiente video se presenta de manera detallada la forma en que se debe realizar el trazo de las prendas superiores, basándose en prendas de vestir infantiles:
    ...
    .row.justify-content-center.mb-5
      .col-lg-4.col-8.col-sm-8.px-lg-4
        .titulo-sexto.color-acento-contenido
          h5 Figura 26. 
    ...
    p.mb-4 A continuación, se presenta el video Trazo de prendas inferiores, con el cual podrá realizar el patronaje de este tipo de prenda.
    ...
    .subt.mb-4(data-aos="fade-right")
      .d-flex.align-items-center.mb-1
        img(src='@/assets/curso/temas/icon-title.svg', alt='')
        h3.mb-0.ms-2 Bolsillo
    
    p.mb-4 Dentro del desarrollo de pantalón se encontrarán especificaciones como partes que conforman un bolsillo, como se presenta en la siguiente imagen: 
    ...
    p.mb-4 El video, a continuación, presenta una explicación detallada del trazo para el pantalón, teniendo en cuenta los detalles relacionados:
